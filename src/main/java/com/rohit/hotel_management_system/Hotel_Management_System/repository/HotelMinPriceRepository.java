...
import com.rohit.hotel_management_system.Hotel_Management_System.entity.HotelMinPrice;
...
public interface HotelMinPriceRepository extends JpaRepository<HotelMinPrice, Long> {
    ...
    @Query("""
            SELECT new com.rohit.hotel_management_system.Hotel_Management_System.dto.HotelPriceDto(i.hotel, AVG(i.price))
